    ...
    <div>
        ...
        @if (Route::has('login'))
                <div class="">
                    ...
                    @else
                    <ul>
                      <li><a href="{{ route('login') }}" class="text-sm text-gray-700 dark:text-gray-500 underline">Se connecter en tant qu'admin</a></li>
                      <li><a href="{{ route('login') }}" class="text-sm text-gray-700 dark:text-gray-500 underline">Se connecter en tant qu'employeur</a></li>
