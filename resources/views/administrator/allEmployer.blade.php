                                    ...
                                    <table class="table header-border">
                                        <thead>
                                            <tr>
                                                ...
                                                <th>Email service</th>
                                                <th>Téléphone service</th>
                                                <th>Situation géographique</th>
                                                <th>Désignation DRH</th>
                                                <th>Email DRH</th>
                                                <th>Téléphone DRH</th>
                                                <th >Action</th>
                                            </tr>
                                        ...
                                        @forelse ($allEmployer as $employers)
                                            ...
                                            <tr>
                                                ...
                                                <td>{{ $employers->servicelocation }}</td>
                                                <td>{{ $employers->firstname }} {{ $employers->lastname }}</td>
                                                <td>{{ $employers->emailDRH }}</td>
                                                <td>{{ $employers->telephoneDRH }}</td>
                                                <td>
                                                    ...
                                                    <a href="{{ route('allemployes', $employers->serviceindex) }}" title="EMPLOYÉS REDEVABLES">
